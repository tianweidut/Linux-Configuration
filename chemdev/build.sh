...
#Web tools
sudo pip install python-django -y   # Django
...
sudo apt-get install libc6 libx11-6 libgtk2.0-0 libglib2.0-0 libpango1.0-0 libcairo2 libatk1.0-0 libgl1-mesa-glx libsqlite3-0
